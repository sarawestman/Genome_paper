...
source("/mnt/picea/projects/aspseq/nstreet/swasp/Sara/GWAS_buds/scripts/R/Pre_GWAS/BLUP_pipeline/generate_BLUP/generate_BLUP.R")
source("/mnt/picea/projects/aspseq/nstreet/swasp/Sara/GWAS_buds/scripts/R/Pre_GWAS/BLUP_pipeline/generate_BLUP/plot_ranef_title.R")

#######################################################################
# Set arguments 
#######################################################################
input_data <- "/mnt/picea/projects/aspseq/nstreet/swasp/Sara/seidr/summer2012_data/buds/LC_GC/raw_data/s12.buds.GCMS_Library_matches_concentration.normalised.txt"
out_dir <- "/mnt/picea/projects/aspseq/nstreet/swasp/Sara/GWAS_buds/Metabolite_data/BLUPs/GC_LibMatch"
data_name <- "GC_LibMatch_buds" # Filename prefix
